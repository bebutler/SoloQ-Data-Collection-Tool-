...
from .forms import DataForm2, BuildForm, GamesForm
...
def opt1(request):
    if request.method == 'POST':
        ...
        form2= BuildForm(request.POST)
        gamesform = GamesForm(request.POST)
        if form.is_valid():
...
#Now the Real fun begins. The following runs the functionality of option 1
    ...
    return render(request, 'alpha/main.html',{'form': form, 'form2':form2, 'gamesform':gamesform})
